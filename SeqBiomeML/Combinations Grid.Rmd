...
```{r}
in_path = "C:/Users/student/Documents/SeqBiomeML-main/SeqBiomeML/R/"
...
```{r}
# Reading in the Data
S_meta = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/16S_metadata.csv")
S_rsv = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/16S_rsv.csv")
S_species = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/16S_species.csv")
S_genus = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/16S_species.csv")
Meta_meta = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/Meta_metadata.csv")
Meta_species = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/Meta_species.csv")
Meta_EC = read.csv("C:/Users/student/Documents/SeqBiomeML-main/Data/Meta_EC.csv")
...
description_file <- "C:/Users/student/Documents/SeqBiomeML-main/SeqBiomeML/DESCRIPTION"
...
S_species1_288_run <- pipeline_iteration_nested(new_comb[1, ], dataset = comp_data, metadata = S_meta, outcome_colname = "ParticipantType", group_colname = "SubjectID", seed = 0)
...
```{r}
new_comb[11:15, ]
res1_40 = rbind(res1_10, res11_15, res16_21, res22_27, res28_34, res35_40)
rm(test)
run1_40 = c(run1_10, run11_15, run16_21, run22_27, run28_34, run35_40)
```
